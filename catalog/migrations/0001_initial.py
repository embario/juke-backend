    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album_type', models.CharField(
                    choices=[('ALBUM', 'Album'), ('SINGLE', 'Single'), ('COMPILATION', 'Compilation')],
                    default='ALBUM',
                    max_length=12)
                 ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tracks', to='catalog.album')),
            ],
            options={
                'abstract': False,
            },
